...
TEST_CASE("Get fractional and integer parts of numbers", "[libutilities]")
{
	...
	REQUIRE_THAT(frac1, Catch::Matchers::WithinRel(0.4, 0.0000001) && Catch::Matchers::WithinULP(0.4, 2));
    auto frac2 = getFractionalPart<int,double>(2.0);
    REQUIRE_THAT(frac2, Catch::Matchers::WithinRel(0.0, 0.0000001) && Catch::Matchers::WithinULP(0.0, 2));
